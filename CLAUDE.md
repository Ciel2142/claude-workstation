...
Workflow context is auto-injected via SessionStart hook (~10KB). Phase-specific protocols (debugging, milestones, spike, scope health, verification) are delivered as on-demand skills.
